...
// 今の環境 g++ -I./ysjoyreader-macosx sample.cpp ./ysjoyreader-macosx/ysjoyreader.cpp ./ysjoyreader-macosx/ysjoyreader-objc.m -framework IOKit -framework Foundation
#include <stdio.h>
#include <./ysjoyreader-macosx/ysjoyreader.h>
#include <unistd.h>
