...
void setup(){
  ...
  Serial.flush();
  //setup_imu();
  rudder.attach(2,1030,2100);
  elevator.attach(3,1030,2100);
  throttle.attach(4,1030,2100);
  aileron.attach(5,1030,2100);
  drop.attach(6,1030,2100);
/*
...
void serial_out(){
  Serial.write(rudder.read());
  Serial.write(elevator.read());
  Serial.write(throttle.read());
  Serial.write(aileron.read());
  Serial.write(drop.read());
  /*
